      ...
      <section className="py-12 md:py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto bg-white rounded-lg p-8 text-center border border-slate-200">
            ...
            <h3 className="text-2xl md:text-xl font-semibold mb-3 text-waze-blue tracking-normal">Mesaj trimis cu succes!</h3>
    ...
    <section className="py-12 md:py-16 bg-slate-50">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-2xl font-bold mb-8 text-center text-waze-blue tracking-normal">Trimite-ne un mesaj</h2>
